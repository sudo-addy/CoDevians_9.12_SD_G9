...
export default function Header({ user, transparent = false }: HeaderProps) {
  ...
  return (
    <header
      className={`border-b-4 border-amber-500 shadow-lg sticky top-0 z-50 ${
        transparent
      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/dashboard" className="flex items-center gap-4 group cursor-pointer">
            <div className="w-12 h-12 bg-amber-500 rounded-lg flex items-center justify-center font-bold text-blue-900 text-xl group-hover:scale-110 transition-transform">
              🏛️
            </div>
            <div>
